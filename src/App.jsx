    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a href="https://github.com/airamfuentes" target="_blank" rel="noreferrer" className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors">
                <ShinyText text="Explora mis proyectos" disabled={false} speed={3} className="custom-class" />
              </a>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-white-500/30">
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="Soy Airam Fuentes, estudiante y apasionado del desarrollo web. Fiel representante de que la innovacioón siempre es la clave y lo creativo siempre se impone"
                  delay={150}
                  animateBy="words"
                  direction="top"
        ...
        <div className="tools mt-32">
          ...
          <p className="w-2/5 text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Mi stack principal</p>
